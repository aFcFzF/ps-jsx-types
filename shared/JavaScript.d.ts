...
interface $ {
     ...
     */
    readonly screens: Array<Record<string, any>>;
...
interface ObjectConstructor {
     ...
     */
    isValid(what: Record<string, any>): boolean;
}
...
interface Object {
     ...
     * @param what The object to check.
     */
    isPrototypeOf(what: Record<string, any>): boolean;
...
interface Function {
     ...
     */
    apply(thisObj: Record<string, any>, args: any): any;
     ...
     */
    call(thisObj: Record<string, any>, ...arguments: any[]): any;
...
interface XMLConstructor {
     ...
     */
    setSettings(obj: Record<string, any>): void;
...
interface UnitValueConstructor {
    readonly prototype: IUnitValue;

    /**
     * Creates a new UnitValue object.
     */
    new (value: string | number | IUnitValue, unit?: string): IUnitValue;
    (value: string | number | IUnitValue, unit?: string): IUnitValue;
...
interface IUnitValue {
     ...
     * @param unitName The unit name.
     */
    convert(unitName: string): boolean;
}
/**
