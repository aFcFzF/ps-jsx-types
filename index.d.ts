...
/* eslint-disable import/unambiguous, max-len, @typescript-eslint/explicit-member-accessibility */

declare interface IFlatValue {
    refclass: string;
    value: string | number;
}

declare type GetFlatTypeRet = File | number | string | boolean | IFlatValue;
...
declare class PathPointInfo {
     ...
     */
    static anchor: Array<Point | [number, number]>;

    /**
     * The x and y coordinates of one end point of the path segment.
     */
    anchor: Array<Point | [number, number]>;
     ...
     */
    static leftDirection: Array<Point | [number, number]>;

    /**
     * The location of the left direction point ("in" position).
     */
    leftDirection: Array<Point | [number, number]>;

    /**
     * The location of the right direction point ("out" position).
     */
    static rightDirection: Array<Point | [number, number]>;

    /**
     * The location of the right direction point ("out" position).
     */
    rightDirection: Array<Point | [number, number]>;
}
...
declare class ActionDescriptor {
    // extend
    public static dumpValue(flatValue: IFlatValue): IFlatValue | string;
    ...
    dumpDesc(keyName: string = ''): void;

    extractBounds(): IUnitValue[];

    getVal<T>(keyList: string[] | string, firstListItemOnly = true): T;

    getFlatType(ID: number): GetFlatTypeRet;
}
...
declare class ActionList {
    ...
    getExtList(key: number): ActionList;
}
...
declare class Document {
     ...
     */
    duplicate(relativeObject: Record<string, any>, insertionLocation: ElementPlacement): Document;
...
declare class ArtLayer extends Layer {
     ...
     */
    adjustCurves(curveShape: Array<Point | [number, number]>): void;
...
declare class Layer {
     ...
     * @param insertionLocation
     */
    duplicate(relativeObject: Record<string, any>, insertionLocation: ElementPlacement): Layer;
     ...
     * @param insertionLocation
     */
    move(relativeObject: Record<string, any>, insertionLocation: ElementPlacement): Layer;
...
declare class Channel {
     ...
     * @param insertionLocation
     */
    duplicate(relativeObject: Record<string, any>, insertionLocation: ElementPlacement): Channel;
...
declare class PathItem {
     ...
     * @param insertionLocation
     */
    duplicate(relativeObject: Record<string, any>, insertionLocation: ElementPlacement): PathItem;
